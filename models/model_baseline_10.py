    ...
    def _build_model(self, is_train):
        ...
        with tf.variable_scope('cnn', reuse=not is_train):
            ...
            x = self._conv_relu_bn(x, {'num_filters': 4*nf, 'filter_size': 3,
                'stride': 1, 'padding': 'same', 'l2': l2, 'is_train': is_train})
            x = self._pool(x, {'filter_size': 2, 'mode': 'max'})
            x = self._conv_relu_bn(x, {'num_filters': 8*nf, 'filter_size': 3,
                'stride': 1, 'padding': 'same', 'l2': l2, 'is_train': is_train})
            x = self._conv_relu_bn(x, {'num_filters': 8*nf, 'filter_size': 3,
                'stride': 1, 'padding': 'same', 'l2': l2, 'is_train': is_train})
            x = self._pool(x, {'filter_size': 2, 'mode': 'max'})
            x = self._conv_relu_bn(x, {'num_filters': 16*nf, 'filter_size': 3,
                'stride': 1, 'padding': 'same', 'l2': l2, 'is_train': is_train})
            x = self._conv_relu_bn(x, {'num_filters': 16*nf, 'filter_size': 3,
                'stride': 1, 'padding': 'same', 'l2': l2, 'is_train': is_train})
            x = self._pool(x, {'filter_size': 2, 'mode': 'max'})
            x = self._conv_relu_bn(x, {'num_filters': 32*nf, 'filter_size': 3,
                'stride': 1, 'padding': 'same', 'l2': l2, 'is_train': is_train})
            x = self._conv_relu_bn(x, {'num_filters': 32*nf, 'filter_size': 3,
                'stride': 1, 'padding': 'same', 'l2': l2, 'is_train': is_train})
            x = self._pool(x, {'filter_size': 2, 'mode': 'max'})
            x = self._flatten(x)
            x = self._fully_connected(x, {'num_outputs': 32, 'l2': l2})
            x = self._fully_connected(x, {'num_outputs': 32, 'l2': l2})
